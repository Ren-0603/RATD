...
class ResidualBlock(nn.Module):
    ...
    def forward(self, x, cond_info, diffusion_emb, reference=None):
...
class diff_RATD(nn.Module):
    def __init__(self, config, inputdim=2, use_ref=False):
        super().__init__()
    ...
    def forward(self, x, cond_info, diffusion_step, reference=None):
        ...
        for layer in self.residual_layers:
            x, skip_connection = layer(x, cond_info, diffusion_emb, reference=None)
